...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    public ObservableCollection<ListItemTemplate> Items { get; } = new()
    {
        ...
        new ListItemTemplate(typeof(CompanyPageViewModel), "CompanyRegular"),
        new ListItemTemplate(typeof(StoragePageViewModel), "StorageRegular"),
        new ListItemTemplate(typeof(ProductPageViewModel), "ProductRegular"),
    };
